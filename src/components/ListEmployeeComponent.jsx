...
const ListEmployeeComponent = () => {
    ...
    //useNavigation is just a function so we can assign it as below for easy variable
   ...
   function addEmployee(){
    navigator('/add-employee') //we will provide a route here which we configure in App.jsx
   }
  ...
  <button className="btn btn-primary mb-2" onClick={addEmployee}>Add Employee</button>
    <table className="table table-striped table-bordered table-hover table-primary">
        <thead>
        <tr>
            <th>Employee Id</th>
